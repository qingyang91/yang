...
/**
 Error code specific to YBBKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, YBBKeychainErrorCode) {
    /** Some of the arguments were invalid. */
    YBBKeychainErrorBadArguments = -1001,
};

/** YBBKeychain error domain */
extern NSString *const kYBBKeychainErrorDomain;

/** Account name. */
extern NSString *const kYBBKeychainAccountKey;
 ...
 */
extern NSString *const kYBBKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kYBBKeychainClassKey;

/** Item description. */
extern NSString *const kYBBKeychainDescriptionKey;

/** Item label. */
extern NSString *const kYBBKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kYBBKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kYBBKeychainWhereKey;
...
/**
 ...
 YBBKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface YBBKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in YBBKeychain.h for a list of keys that can be used when accessing the
