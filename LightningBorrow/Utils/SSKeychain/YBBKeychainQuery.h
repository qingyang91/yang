...
#define YBBKeychain_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
// Keychain access group available at compile time
#define YBBKeychain_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef YBBKeychain_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, YBBKeychainQuerySynchronizationMode) {
    YBBKeychainQuerySynchronizationModeAny,
    YBBKeychainQuerySynchronizationModeNo,
    YBBKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface YBBKeychainQuery : NSObject
...
@property (nonatomic) YBBKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 YBBKeychain_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
