...
//        self.font = [self.font fontWithSize:fontSize*(scale?:ScrenScale)];
        self.font = [UIFont fontWithName:self.font.fontName size:fontSize*(scale?:ScrenScale)];
    }
    return self;
}
...
//        self.titleLabel.font = [self.titleLabel.font fontWithSize:fontSize*(scale?:ScrenScale)];
        self.titleLabel.font = [UIFont fontWithName:self.titleLabel.font.fontName size:fontSize*(scale?:ScrenScale)];
    }
    return self;
}
