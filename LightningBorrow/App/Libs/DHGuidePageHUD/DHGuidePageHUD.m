...
//            if (i == imageNameArray.count-1 && isHidden == NO) {
            ...
            if (i == 0) {
                _startButton1 = [[UIButton alloc]initWithFrame:CGRectMake(kScreenW/2-90, 100, 178, kScreenH-100)];
                _startButton1.layer.borderColor = [UIColor colorWithHexString:@"#979797"].CGColor;
                //                _startButton.layer.borderWidth = 1;
                //                _startButton.layer.cornerRadius = 21;
                //                _startButton.layer.masksToBounds = YES;
                //                [_startButton setTitle:@"立即开启" forState:UIControlStateNormal];
                //                [_startButton setTitleColor:UIColorWhite forState:UIControlStateNormal];
                //                [_startButton.titleLabel setFont:[UIFont systemFontOfSize:16]];
                //                [_startButton setBackgroundImage:[UIImage imageNamed:@"GuideImage.bundle/guideImage_button_backgound"] forState:UIControlStateNormal];
                [_startButton1 addTarget:self action:@selector(buttonClick:) forControlEvents:UIControlEventTouchUpInside];
                [imageView addSubview:_startButton1];
            }
            if (i == 1) {
                _startButton = [[UIButton alloc]initWithFrame:CGRectMake(kScreenW/2-90, 100, 178, kScreenH-100)];
                _startButton.layer.borderColor = [UIColor colorWithHexString:@"#979797"].CGColor;
                //                _startButton.layer.borderWidth = 1;
                //                _startButton.layer.cornerRadius = 21;
                //                _startButton.layer.masksToBounds = YES;
                //                [_startButton setTitle:@"立即开启" forState:UIControlStateNormal];
...
//            }
        ...
        self.imagePageControl.currentPageIndicatorTintColor = UIColorWhite;
